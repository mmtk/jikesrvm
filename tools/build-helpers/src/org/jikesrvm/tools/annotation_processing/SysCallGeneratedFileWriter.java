...
class SysCallGeneratedFileWriter extends AbstractGeneratedFileWriter {
   ...
   * @throws IOException
   */
  void processMethod(ExecutableElement method, boolean aligned, boolean isTPH) throws IOException {
    generateMethodImplementation(method, isTPH);
    generatePrivateNativeStub(method, aligned);
  }

  private void generateMethodImplementation(ExecutableElement method, boolean isTPH)
      throws IOException {
    ...
    methodBody.append(getMethodName(method) + (isTPH ? "RIP" : "IP"));
